function HCPA_scatter_PhenoCorr_vs_PredErrCorr(PhenoCorr_mat, PredErrCorr_mat, outpng)

    % HCPA_scatter_PhenoCorr_vs_PredErrCorr(PhenoCorr_mat, PredErrCorr_mat, outpng)
    %
    % 
