...
CPUS='1'
RAM='5G'
LOGS_DIR=$proj_dir/new_results/HCP/Jacobian_resize/logs
...
request_memory = ${RAM}
# Execution
initial_dir    = $proj_dir/new_scripts/PredErr_vs_multifactors/HCP
executable     = HCP_Jacobian_resize.sh
transfer_executable   = False
\n"

indir=$proj_dir/Jacobian/HCP/HCP_cat12.8.1
outdir=$proj_dir/new_results/HCP/Jacobian_resize
