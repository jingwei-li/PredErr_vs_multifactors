function HCP_behavior_vs_IndivAnat(avgBehavior, outdir, Xlabels, anat_metric, varargin)

% HCP_behavior_vs_IndivAnat(avgBehavior, outdir, Xlabels, anat_metric, varargin)
%
% Compulsory inputs:
%   - avgBehavior
...
case 'Euler'
    ...
    HCP_scatter_PredErr_vs_other_var(bhvr_avg, euler, outdir, outbase, Xlabels, Ylabel, 1)

    Ylabel = 'log( - Euler characteristic)';
    outbase = 'behavior_vs_log-Euler';
    HCP_scatter_PredErr_vs_other_var(bhvr_avg, log(-euler), outdir, outbase, Xlabels, Ylabel, 1)
case 'ICV'
    ...
    HCP_scatter_PredErr_vs_other_var(bhvr_avg, ICV, outdir, outbase, Xlabels, Ylabel, 1)
case 'Jacobian'
    ...
    HCP_scatter_PredErr_vs_other_var(bhvr_avg, Jacobian, outdir, outbase, Xlabels, Ylabel, 1)
otherwise
