function HCP_PredErr_vs_IndivFunc(avgPredErr, outdir, Xlabels, func_metric, varargin)

% HCP_PredErr_vs_IndivFunc(avgPredErr, outdir, Xlabels, func_metric, varargin)
%
% Compulsory inputs:
%   - avgPredErr
...
case 'rsfc_homo'
    ...
    HCP_scatter_PredErr_vs_other_var(err_avg, homo_out, outdir, outbase, Xlabels, Ylabel, 1)
otherwise
