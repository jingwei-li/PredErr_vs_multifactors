function HCP_Jacobian_all_subj(subj_ls, outtxt, maskname, Jacobian_dir)

% HCP_Jacobian_all_subj(subj_ls, outtxt, maskname, Jacobian_dir)
%
% Inputs:
%   - subj_ls
%     A string. The list of subject IDs.
%     E.g. '/data/project/predict_stereotype/from_sg/HCP_race/scripts/lists/subjects_wIncome_948.txt'
%   - outtxt
%     A string. The output list of Jacobian standard deviation of all subjects.
%     E.g. '/data/project/predict_stereotype/new_results/HCP/lists/Jacobian.subjects_wIncome_948.txt'
%   - maskname
...
%     Default: '/data/project/predict_stereotype/new_results/HCP/Jacobian_resize'
%
% Author: Jingwei Li
% Date: 2023/12/12
%
...
if(~exist('Jacobian_dir', 'var') || isempty(Jacobian_dir))
    Jacobian_dir = fullfile(proj_dir, 'new_results', 'HCP', 'Jacobian_resize');
end
