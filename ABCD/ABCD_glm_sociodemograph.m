function ABCD_glm_sociodemograph(avgPredErr, outdir, subj_ls, ABCD_csv_dir)

% ABCD_glm_sociodemograph(avgPredErr, outdir, subj_ls, ABCD_csv_dir)
%
% Build a full GLM with all scan-related covariates: parental education, family income, 
% ethnicity, age, sex.
