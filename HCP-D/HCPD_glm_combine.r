...
for (n in 1:Nerr) {
    ...
    fullModelStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + FD + age + sex + income', sep = "")
    ...
    noEulerStr <- paste('err_class', toString(n), ' ~ 1 + ICV + FD + age + sex + income', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noICVStr <- paste('err_class', toString(n), ' ~ 1 + euler + FD + age + sex + income', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noFDStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + age + sex + income', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noAgeStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + FD + sex + income', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noSexStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + FD + age + income', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noEducStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + FD + age + sex + income', sep = "")
    for (i in 1:length(ethnicity_idx)) {
    ...
    noEthnStr <- paste('err_class', toString(n), ' ~ 1 + euler + ICV + FD + age + sex + income', sep = "")
    for (i in 1:length(educ_idx)) {
