function HCPD_behavior_vs_sociodemograph(avgBehavior, sublist, outdir, bhvr_cls_names, metric)

% HCPD_behavior_vs_sociodemograph(avgBehavior, sublist, outdir, bhvr_cls_names, metric)
%
% Compulsory inputs:
%   - avgBehavior
...
%
%   - sublist
%     Subject list. E.g. '/data/project/predict_stereotype/new_results/HCP-D/lists/sublist_allbehavior_455sub.csv'
%
%   - outdir
...
case 'handedness'
    ...
    HCPA_violin_PredErr_vs_other_var(hand_LR, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
case 'educ'
    ...
    HCPA_violin_PredErr_vs_other_var(educ_num, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
case 'prnt_educ'
    csv = fullfile(csv_dir, 'socdem01.txt');
    d = readtable(csv);
    [~, ~, idx] = intersect(subjects, d.(subj_hdr), 'stable');
    ...
    Ylabel = 'Behavioral scores';
    outbase = 'behavior_vs_prnt_educ';
    HCPA_violin_PredErr_vs_other_var(peduc_num, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
    ...
    Ylabel = 'Behavioral scores';
    outbase = 'behavior_vs_prnt_ptnr_educ';
    HCPA_violin_PredErr_vs_other_var(ptnr_educ_num, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
case 'income'
    csv = fullfile(csv_dir, 'socdem01.txt');
    d = readtable(csv);
    [~, ~, idx] = intersect(subjects, d.(subj_hdr), 'stable');
    ...
    HCPA_scatter_PredErr_vs_other_var(bhvr_avg, income, outdir, outbase, bhvr_cls_names, Ylabel, 1)
case 'race'
    csv = fullfile(csv_dir, 'socdem01.txt');
    d = readtable(csv);
    [~, ~, idx] = intersect(subjects, d.(subj_hdr), 'stable');
    ...
    outbase = 'behavior_vs_race';
    HCPA_violin_PredErr_vs_other_var(Xdata, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
    ...
    outbase = 'behavior_vs_race_removeSingleDataPoint';
    HCPA_violin_PredErr_vs_other_var(Xdata2, bhvr_avg, outdir, outbase, XTickLabels2, Xlabel, Ylabel, bhvr_cls_names, 1)
case 'age'
    csv = fullfile(csv_dir, 'socdem01.txt');
    d = readtable(csv);
    [~, ~, idx] = intersect(subjects, d.(subj_hdr), 'stable');
    ...
    HCPA_scatter_PredErr_vs_other_var(bhvr_avg, age, outdir, outbase, bhvr_cls_names, Ylabel, 1)
case 'sex'
    csv = fullfile(csv_dir, 'socdem01.txt');
    d = readtable(csv);
    [~, ~, idx] = intersect(subjects, d.(subj_hdr), 'stable');
    ...
    HCPA_violin_PredErr_vs_other_var(sex, bhvr_avg, outdir, outbase, XTickLabels, Xlabel, Ylabel, bhvr_cls_names, 1)
case 'site'
