...
for (n in 1:Nerr) {
    ...
    fullModelStr <- paste('err_class', toString(n), ' ~ 1 + age + sex', sep = "")
    ...
    noAgeStr <- paste('err_class', toString(n), ' ~ 1 + sex', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noSexStr <- paste('err_class', toString(n), ' ~ 1 + age', sep = "")
    for (i in 1:length(educ_idx)) {
    ...
    noEducStr <- paste('err_class', toString(n), ' ~ 1 + age + sex', sep = "")
    for (i in 1:length(income_idx)) {
    ...
    noEthnStr <- paste('err_class', toString(n), ' ~ 1 + age + sex', sep = "")
    for (i in 1:length(educ_idx)) {
